...
/**
 * 14001-assetViewer [BASE]
 */
class GUI_14001 extends GUI_BASE {
   bg:UIBitmap;
   文本:UIString;
   list:UIList; // Item=14002
   tab:UITabBox;
   pictures:UIString;
   pictureMemory:UIString;
   appMemory:UIString;
   refreshBtn:UIButton;
   copyBtn:UIButton;
   closeBtn:UIButton;
...
class ListItem_14001 extends UIListItemData {
   bg:string;
   文本:string;
   list:UIListItemData[];
   tab:string;
   pictures:string;
   pictureMemory:string;
   appMemory:string;
   website:string;
}

/**
 * 14002-assetViewer_Item [BASE]
 */
class GUI_14002 extends GUI_BASE {
   图片:UIBitmap;
   imageSprite:UIRoot;
   url:UIString;
   sizeText:UIString;
...
class ListItem_14002 extends UIListItemData {
   图片:string;
   url:string;
   sizeText:string;
}
